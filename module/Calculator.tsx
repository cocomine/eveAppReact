            ...
            <View style={{flex: 1, flexDirection: 'column'}}>
                ...
                <View style={{flex: 3 / 4}}>
                    <View style={[style.row]}>
                        <Ripple.Color onPress={onAC}><View style={style.button}><Text style={style.text}>AC</Text></View></Ripple.Color>
                        <Ripple.Color onPress={() => onPress('÷')}><View style={style.button}><Text style={style.text}>÷</Text></View></Ripple.Color>
                        <Ripple.Color onPress={() => onPress('×')}><View style={style.button}><Text style={style.text}>×</Text></View></Ripple.Color>
                        <Ripple.Color onPress={onBack}><View style={style.button}><IconButton icon={'backspace-outline'} iconColor={colors.text}/></View></Ripple.Color>
                    </View>
                    <View style={[style.row, {backgroundColor: BG_color}]}>
                        ...
                        <Ripple.Color onPress={() => onPress('–')}><View style={[style.button, {backgroundColor: colors.background}]}><Text style={style.text}>–</Text></View></Ripple.Color>
                    </View>
                    <View style={[style.row, {backgroundColor: BG_color}]}>
                    ...
                    <View style={[style.row, {backgroundColor: BG_color}]}>
                        ...
                        <Ripple.Color onPress={onCalculator}><View style={[style.button, {backgroundColor: colors.background}]}><Text style={style.text}>=</Text></View></Ripple.Color>
                    </View>
                    <View style={[style.row, {backgroundColor: BG_color}]}>
                        ...
                        <Ripple.Color onPress={() => onPress('.')}><View style={style.button}><Text style={style.text}>.</Text></View></Ripple.Color>
                        <Ripple.Color onPress={onDone}><View style={[style.button, {backgroundColor: Color.primaryColor}]}><Text style={[style.text, {color: Color.white}]}>完成</Text></View></Ripple.Color>
                    </View>
                </View>
            </View>
            {/*</React.StrictMode>*/}
